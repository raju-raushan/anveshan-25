...
const HeroSection: React.FC = () => {
  const stats = [
    { icon: Users, label: 'Expected Participants', value: '5000+' },
    { icon: Zap, label: 'Tech Events', value: '50+' },
    { icon: Calendar, label: 'Days of Innovation', value: '3' },
    { icon: MapPin, label: 'Venue', value: 'TechNova Campus' },
  ];

  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden tech-bg">
        ...
        >
          ...
          >
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-primary/30 text-primary hover:bg-primary hover:text-primary-foreground transition-all duration-300 text-lg px-8 py-6"
            >
              Explore Events
            </Button>
          </motion.div>
